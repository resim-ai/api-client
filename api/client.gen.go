...
type AddSuitesToExperiencesInput struct {
	...
	TestSuiteIDs   []TestSuiteID          `json:"testSuiteIDs" yaml:"testSuiteIDs"`
}
...
type BatchJobStatusCounts struct {
	...
	MetricsQueued  int `json:"metricsQueued" yaml:"metricsQueued"`
	MetricsRunning int `json:"metricsRunning" yaml:"metricsRunning"`
	Running        int `json:"running" yaml:"running"`
	Submitted      int `json:"submitted" yaml:"submitted"`
...
type BatchMetric struct {
	BatchID           *BatchID         `json:"batchID,omitempty" yaml:"batchID,omitempty"`
	CreationTimestamp *Timestamp       `json:"creationTimestamp,omitempty" yaml:"creationTimestamp,omitempty"`
	DataIDs           *[]MetricsDataID `json:"dataIDs,omitempty" yaml:"dataIDs,omitempty"`

	// EventMetric true if this metric is for an event
	EventMetric  *bool           `json:"eventMetric,omitempty" yaml:"eventMetric,omitempty"`
	FileLocation *MetricLocation `json:"fileLocation,omitempty" yaml:"fileLocation,omitempty"`
	MetricID     *MetricID       `json:"metricID,omitempty" yaml:"metricID,omitempty"`
	MetricURL    *MetricURL      `json:"metricURL,omitempty" yaml:"metricURL,omitempty"`
	Name         *MetricName     `json:"name,omitempty" yaml:"name,omitempty"`
	OrgID        *OrgID          `json:"orgID,omitempty" yaml:"orgID,omitempty"`
	ProjectID    *ProjectID      `json:"projectID,omitempty" yaml:"projectID,omitempty"`
	Status       *MetricStatus   `json:"status,omitempty" yaml:"status,omitempty"`
...
type BatchMetricsData struct {
	BatchID           *BatchID             `json:"batchID,omitempty" yaml:"batchID,omitempty"`
	CreationTimestamp *Timestamp           `json:"creationTimestamp,omitempty" yaml:"creationTimestamp,omitempty"`
	DataID            *MetricsDataID       `json:"dataID,omitempty" yaml:"dataID,omitempty"`
	FileLocation      *MetricsDataLocation `json:"fileLocation,omitempty" yaml:"fileLocation,omitempty"`
	Filename          *string              `json:"filename" yaml:"filename"`
	MetricsDataType   *MetricsDataType     `json:"metricsDataType,omitempty" yaml:"metricsDataType,omitempty"`
	MetricsDataURL    *MetricsDataURL      `json:"metricsDataURL,omitempty" yaml:"metricsDataURL,omitempty"`
...
type BatchMetricsDataAndIDs struct {
	BatchMetricID    *MetricID         `json:"batchMetricID,omitempty" yaml:"batchMetricID,omitempty"`
	BatchMetricsData *BatchMetricsData `json:"batchMetricsData,omitempty" yaml:"batchMetricsData,omitempty"`
}
...
type BatchSuggestionsOutput struct {
	LastPassingOnBranch *Batch `json:"lastPassingOnBranch" yaml:"lastPassingOnBranch"`
	LastPassingOnMain   *Batch `json:"lastPassingOnMain" yaml:"lastPassingOnMain"`
	LatestOnBranch      *Batch `json:"latestOnBranch" yaml:"latestOnBranch"`
	LatestOnMain        *Batch `json:"latestOnMain" yaml:"latestOnMain"`
}
...
type Build struct {
	...
	BuildSpecification BuildSpecificationOutput `json:"buildSpecification" yaml:"buildSpecification"`
	CreationTimestamp  Timestamp                `json:"creationTimestamp" yaml:"creationTimestamp"`

	// Description The description of the build. May be a SHA or commit message.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Description BuildDescription `json:"description" yaml:"description"`
...
type CompareBatchTest struct {
	...
	FromTest       *CompareBatchTestDetails `json:"fromTest" yaml:"fromTest"`
	ToTest         *CompareBatchTestDetails `json:"toTest" yaml:"toTest"`
}
...
type CompareBatchTestDetails struct {
	...
	NumMetrics *int               `json:"numMetrics" yaml:"numMetrics"`
	Status     ConflatedJobStatus `json:"status" yaml:"status"`
}
...
type CompareBatchesOutput struct {
	...
	Tests         []CompareBatchTest `json:"tests" yaml:"tests"`
...
type CreateBuildForBranchInput struct {
	AssociatedAccount  *AssociatedAccount       `json:"associatedAccount,omitempty" yaml:"associatedAccount,omitempty"`
	BuildSpecification *BuildSpecificationInput `json:"buildSpecification,omitempty" yaml:"buildSpecification,omitempty"`

	// Description The description of the build. May be a SHA or commit message.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Description *BuildDescription `json:"description,omitempty" yaml:"description,omitempty"`
...
type CreateExperienceInput struct {
	...
	SystemIDs *[]SystemID    `json:"systemIDs,omitempty" yaml:"systemIDs,omitempty"`
}
...
type CreateMetricsBuildInput struct {
	ImageUri MetricsBuildImageUri `json:"imageUri" yaml:"imageUri"`
	Name     MetricsBuildName     `json:"name" yaml:"name"`
	Version  MetricsBuildVersion  `json:"version" yaml:"version"`
}
...
type CreateSystemInput struct {
	...
	BuildGpus                  int           `json:"build_gpus" yaml:"build_gpus"`
	BuildMemoryMib             int           `json:"build_memory_mib" yaml:"build_memory_mib"`
...
type CreateTestSuiteInput struct {
	AllExperiences        *bool                   `json:"allExperiences,omitempty" yaml:"allExperiences,omitempty"`
	Description           TestSuiteDescription    `json:"description" yaml:"description"`
	ExcludedExperienceIDs *[]ExcludedExperienceID `json:"excludedExperienceIDs,omitempty" yaml:"excludedExperienceIDs,omitempty"`
	Experiences           []ExperienceID          `json:"experiences" yaml:"experiences"`
	Filters               *ExperienceFilterInput  `json:"filters,omitempty" yaml:"filters,omitempty"`
	MetricsBuildID        *MetricsBuildID         `json:"metricsBuildID,omitempty" yaml:"metricsBuildID,omitempty"`
	MetricsSetName        *MetricsSetName         `json:"metricsSetName" yaml:"metricsSetName"`
	Name                  TestSuiteName           `json:"name" yaml:"name"`
	ShowOnSummary         *bool                   `json:"showOnSummary,omitempty" yaml:"showOnSummary,omitempty"`
	SummaryReferenceDate  *Timestamp              `json:"summaryReferenceDate,omitempty" yaml:"summaryReferenceDate,omitempty"`
	SystemID              SystemID                `json:"systemID" yaml:"systemID"`
}

// CreateWorkflowInput defines model for createWorkflowInput.
type CreateWorkflowInput struct {
	CiWorkflowLink *string              `json:"ciWorkflowLink,omitempty" yaml:"ciWorkflowLink,omitempty"`
	Description    string               `json:"description" yaml:"description"`
	Name           string               `json:"name" yaml:"name"`
	WorkflowSuites []WorkflowSuiteInput `json:"workflowSuites" yaml:"workflowSuites"`
}
...
// CreateWorkflowSuiteInput defines model for createWorkflowSuiteInput.
type CreateWorkflowSuiteInput struct {
	Enabled     Enabled     `json:"enabled" yaml:"enabled"`
	TestSuiteID TestSuiteID `json:"testSuiteID" yaml:"testSuiteID"`
}

// CreateWorkflowSuiteOutput defines model for createWorkflowSuiteOutput.
type CreateWorkflowSuiteOutput struct {
	Enabled     Enabled     `json:"enabled" yaml:"enabled"`
	TestSuiteID TestSuiteID `json:"testSuiteID" yaml:"testSuiteID"`
	WorkflowID  WorkflowID  `json:"workflowID" yaml:"workflowID"`
}

// CreateWorkflowSuitesInput defines model for createWorkflowSuitesInput.
type CreateWorkflowSuitesInput struct {
	WorkflowSuites []CreateWorkflowSuiteInput `json:"workflowSuites" yaml:"workflowSuites"`
}

// CreateWorkflowSuitesOutput defines model for createWorkflowSuitesOutput.
type CreateWorkflowSuitesOutput struct {
...
type DebugExperienceInput struct {
	BatchID     *BatchID         `json:"batchID,omitempty" yaml:"batchID,omitempty"`
	BuildID     *BuildID         `json:"buildID,omitempty" yaml:"buildID,omitempty"`
	Containers  *[]ContainerName `json:"containers,omitempty" yaml:"containers,omitempty"`
	PoolLabels  *PoolLabels      `json:"poolLabels,omitempty" yaml:"poolLabels,omitempty"`
	TestSuiteID *TestSuiteID     `json:"testSuiteID,omitempty" yaml:"testSuiteID,omitempty"`
}
...
type DebugExperienceOutput struct {
	BatchID         *BatchID `json:"batchID,omitempty" yaml:"batchID,omitempty"`
	ClusterCAData   *string  `json:"clusterCAData,omitempty" yaml:"clusterCAData,omitempty"`
...
// DeleteWorkflowSuitesInput defines model for deleteWorkflowSuitesInput.
type DeleteWorkflowSuitesInput struct {
	TestSuiteIDs []TestSuiteID `json:"testSuiteIDs" yaml:"testSuiteIDs"`
}
...
type Event struct {
	CreationTimestamp Timestamp          `json:"creationTimestamp" yaml:"creationTimestamp"`
	Description       string             `json:"description" yaml:"description"`
	EventID           EventID            `json:"eventID" yaml:"eventID"`
	MetricsIDs        []MetricID         `json:"metricsIDs" yaml:"metricsIDs"`
	Name              string             `json:"name" yaml:"name"`
	Status            MetricStatus       `json:"status" yaml:"status"`
	Tags              EventTags          `json:"tags" yaml:"tags"`
	Timestamp         Timestamp          `json:"timestamp" yaml:"timestamp"`
	TimestampType     EventTimestampType `json:"timestampType" yaml:"timestampType"`
}
...
type ExecutionError struct {
	...
	ParentID *openapi_types.UUID `json:"parentID,omitempty" yaml:"parentID,omitempty"`
	...
	RunCounter *int `json:"runCounter,omitempty" yaml:"runCounter,omitempty"`
}
...
// ExperienceSyncConfig defines model for experienceSyncConfig.
type ExperienceSyncConfig struct {
	Experiences           []ExperienceSyncExperience `json:"experiences" yaml:"experiences"`
	ManagedExperienceTags []ExperienceTagName        `json:"managedExperienceTags" yaml:"managedExperienceTags"`
	ManagedTestSuites     []ExperienceSyncTestSuite  `json:"managedTestSuites" yaml:"managedTestSuites"`
}
...
type ExperienceSyncTestSuite struct {
	Experiences []ExperienceName `json:"experiences" yaml:"experiences"`
	Name        TestSuiteName    `json:"name" yaml:"name"`
}
...
type ExperienceTag struct {
	CreationTimestamp Timestamp         `json:"creationTimestamp" yaml:"creationTimestamp"`
	Description       string            `json:"description" yaml:"description"`
	ExperienceTagID   ExperienceTagID   `json:"experienceTagID" yaml:"experienceTagID"`
	Name              ExperienceTagName `json:"name" yaml:"name"`
	OrgID             OrgID             `json:"orgID" yaml:"orgID"`
	ProjectID         ProjectID         `json:"projectID" yaml:"projectID"`
	UserID            UserID            `json:"userID" yaml:"userID"`
...
type FirstBuildMetric struct {
	...
	Time  Timestamp `json:"time" yaml:"time"`
	Value float64   `json:"value" yaml:"value"`
}
...
type GetQuotaOutput struct {
	AvailableTokens     *int32 `json:"availableTokens,omitempty" yaml:"availableTokens,omitempty"`
	MaxTokens           *int32 `json:"maxTokens,omitempty" yaml:"maxTokens,omitempty"`
	OrgID               *OrgID `json:"orgID,omitempty" yaml:"orgID,omitempty"`
	SecondsUntilRefresh *int32 `json:"secondsUntilRefresh,omitempty" yaml:"secondsUntilRefresh,omitempty"`
}

// GetWorkflowSuiteOutput defines model for getWorkflowSuiteOutput.
type GetWorkflowSuiteOutput struct {
	Enabled     Enabled     `json:"enabled" yaml:"enabled"`
	TestSuiteID TestSuiteID `json:"testSuiteID" yaml:"testSuiteID"`
}
...
type Job struct {
	...
	BranchID                       *BranchID              `json:"branchID,omitempty" yaml:"branchID,omitempty"`
	BuildID                        *BuildID               `json:"buildID,omitempty" yaml:"buildID,omitempty"`
	ConflatedStatus                *ConflatedJobStatus    `json:"conflatedStatus,omitempty" yaml:"conflatedStatus,omitempty"`
	CreationTimestamp              *Timestamp             `json:"creationTimestamp,omitempty" yaml:"creationTimestamp,omitempty"`
	Description                    *string                `json:"description,omitempty" yaml:"description,omitempty"`
	ExecutionError                 *ExecutionError        `json:"executionError,omitempty" yaml:"executionError,omitempty"`
	ExecutionErrors                *[]ExecutionError      `json:"executionErrors" yaml:"executionErrors"`
	...
	ProjectID                      *ProjectID             `json:"projectID,omitempty" yaml:"projectID,omitempty"`
	RunCounter                     *RunCounter            `json:"runCounter,omitempty" yaml:"runCounter,omitempty"`
	StatusHistory                  *JobStatusHistory      `json:"statusHistory,omitempty" yaml:"statusHistory,omitempty"`
	SystemID                       *SystemID              `json:"systemID,omitempty" yaml:"systemID,omitempty"`
	UserID                         *UserID                `json:"userID,omitempty" yaml:"userID,omitempty"`
...
type JobMetricsStatusCounts struct {
	FailBlock        int `json:"failBlock" yaml:"failBlock"`
	FailWarn         int `json:"failWarn" yaml:"failWarn"`
	NoStatusReported int `json:"noStatusReported" yaml:"noStatusReported"`
	NotApplicable    int `json:"notApplicable" yaml:"notApplicable"`
	Passed           int `json:"passed" yaml:"passed"`
	Raw              int `json:"raw" yaml:"raw"`
}
...
type KeyMetric struct {
	// FirstBuildMetric The first batch metric in the sequence, and some info about how it has changed
	FirstBuildMetric *FirstBuildMetric           `json:"firstBuildMetric" yaml:"firstBuildMetric"`
	LatestValue      float64                     `json:"latestValue" yaml:"latestValue"`
	Name             string                      `json:"name" yaml:"name"`
	Performance      []KeyMetricPerformancePoint `json:"performance" yaml:"performance"`

	// Target The optional desired target for this metric
	Target *KeyMetricTarget `json:"target" yaml:"target"`
	Unit   *string          `json:"unit" yaml:"unit"`
}
...
type ListBatchLogsOutput struct {
	Logs          *[]BatchLog `json:"logs,omitempty" yaml:"logs,omitempty"`
	NextPageToken *string     `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListBatchMetricsDataForBatchMetricIDsOutput struct {
	BatchMetricsDataAndIDs *[]BatchMetricsDataAndIDs `json:"batchMetricsDataAndIDs,omitempty" yaml:"batchMetricsDataAndIDs,omitempty"`
	NextPageToken          *string                   `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListBatchMetricsOutput struct {
	BatchMetrics  *[]BatchMetric `json:"batchMetrics,omitempty" yaml:"batchMetrics,omitempty"`
	NextPageToken *string        `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListExperiencesOutput struct {
	Experiences   *[]Experience `json:"experiences,omitempty" yaml:"experiences,omitempty"`
	NextPageToken *string       `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
	Total         *int          `json:"total,omitempty" yaml:"total,omitempty"`
}
...
type ListJobMetricsDataOutput struct {
	MetricsData   *[]JobMetricsData `json:"metricsData,omitempty" yaml:"metricsData,omitempty"`
	NextPageToken *string           `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListMetricsBuildOutput struct {
	MetricsBuilds []MetricsBuild `json:"metricsBuilds" yaml:"metricsBuilds"`
	NextPageToken string         `json:"nextPageToken" yaml:"nextPageToken"`
	Total         int            `json:"total" yaml:"total"`
}
...
type ListMetricsDataAndMetricIDOutput struct {
	MetricsDataAndIDs *[]MetricsDataAndMetricID `json:"metricsDataAndIDs,omitempty" yaml:"metricsDataAndIDs,omitempty"`
	NextPageToken     *string                   `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListReportLogsOutput struct {
	Logs          *[]ReportLog `json:"logs,omitempty" yaml:"logs,omitempty"`
	NextPageToken *string      `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
}
...
type ListReportMetricsDataForReportMetricIDsOutput struct {
	NextPageToken           *string                    `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
	ReportMetricsDataAndIDs *[]ReportMetricsDataAndIDs `json:"reportMetricsDataAndIDs,omitempty" yaml:"reportMetricsDataAndIDs,omitempty"`
}

// ListReportMetricsDataOutput defines model for listReportMetricsDataOutput.
type ListReportMetricsDataOutput struct {
	NextPageToken     *string        `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
	ReportMetricsData *[]MetricsData `json:"reportMetricsData,omitempty" yaml:"reportMetricsData,omitempty"`
}

// ListReportMetricsOutput defines model for listReportMetricsOutput.
type ListReportMetricsOutput struct {
	NextPageToken *string   `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
	ReportMetrics *[]Metric `json:"reportMetrics,omitempty" yaml:"reportMetrics,omitempty"`
}
...
type ListTagsForBatchMetricsOutput struct {
	NextPageToken *string      `json:"nextPageToken,omitempty" yaml:"nextPageToken,omitempty"`
	Tags          *[]MetricTag `json:"tags,omitempty" yaml:"tags,omitempty"`
}
...
type ListTestSuiteOutput struct {
	NextPageToken string      `json:"nextPageToken" yaml:"nextPageToken"`
	TestSuites    []TestSuite `json:"testSuites" yaml:"testSuites"`
	Total         int         `json:"total" yaml:"total"`
}
...
type ListWorkflowRunsOutput struct {
	NextPageToken string        `json:"nextPageToken" yaml:"nextPageToken"`
	Total         int           `json:"total" yaml:"total"`
	WorkflowRuns  []WorkflowRun `json:"workflowRuns" yaml:"workflowRuns"`
}

// ListWorkflowSuitesOutput defines model for listWorkflowSuitesOutput.
type ListWorkflowSuitesOutput struct {
	WorkflowSuites []WorkflowSuiteOutput `json:"workflowSuites" yaml:"workflowSuites"`
}
...
type MetricTag struct {
	...
	MetricID          *openapi_types.UUID `json:"metricID,omitempty" yaml:"metricID,omitempty"`
	Name              string              `json:"name" yaml:"name"`
	TagID             *TagID              `json:"tagID,omitempty" yaml:"tagID,omitempty"`
	Value             string              `json:"value" yaml:"value"`
}
...
type MetricsBuild struct {
	CreationTimestamp Timestamp            `json:"creationTimestamp" yaml:"creationTimestamp"`
	ImageUri          MetricsBuildImageUri `json:"imageUri" yaml:"imageUri"`
	MetricsBuildID    MetricsBuildID       `json:"metricsBuildID" yaml:"metricsBuildID"`
	Name              MetricsBuildName     `json:"name" yaml:"name"`
	OrgID             OrgID                `json:"orgID" yaml:"orgID"`
	ProjectID         ProjectID            `json:"projectID" yaml:"projectID"`
	UserID            UserID               `json:"userID" yaml:"userID"`
...
type MutateSystemsToExperienceInput struct {
	...
	Experiences    *[]ExperienceID        `json:"experiences,omitempty" yaml:"experiences,omitempty"`
	Filters        *ExperienceFilterInput `json:"filters,omitempty" yaml:"filters,omitempty"`
	SystemIDs      []SystemID             `json:"systemIDs" yaml:"systemIDs"`
}
...
type ParameterSweep struct {
	AssociatedAccount    AssociatedAccount            `json:"associatedAccount" yaml:"associatedAccount"`
	Batches              *[]BatchID                   `json:"batches,omitempty" yaml:"batches,omitempty"`
	CreationTimestamp    *Timestamp                   `json:"creationTimestamp,omitempty" yaml:"creationTimestamp,omitempty"`
	LastUpdatedTimestamp *Timestamp                   `json:"lastUpdatedTimestamp,omitempty" yaml:"lastUpdatedTimestamp,omitempty"`
	Name                 *string                      `json:"name,omitempty" yaml:"name,omitempty"`
	OrgID                *OrgID                       `json:"orgID,omitempty" yaml:"orgID,omitempty"`
	ParameterSweepID     *ParameterSweepID            `json:"parameterSweepID,omitempty" yaml:"parameterSweepID,omitempty"`
	Parameters           *[]SweepParameter            `json:"parameters,omitempty" yaml:"parameters,omitempty"`
	ProjectID            *ProjectID                   `json:"projectID,omitempty" yaml:"projectID,omitempty"`
	Status               *ParameterSweepStatus        `json:"status,omitempty" yaml:"status,omitempty"`
	StatusHistory        *ParameterSweepStatusHistory `json:"statusHistory,omitempty" yaml:"statusHistory,omitempty"`
	UserID               *UserID                      `json:"userID,omitempty" yaml:"userID,omitempty"`
}
...
type ReferenceBatchSummary struct {
	FixedTests int64 `json:"fixedTests" yaml:"fixedTests"`
	NewIssues  int64 `json:"newIssues" yaml:"newIssues"`
...
type Report struct {
	...
	BranchID                BranchID                `json:"branchID" yaml:"branchID"`
	CreationTimestamp       Timestamp               `json:"creationTimestamp" yaml:"creationTimestamp"`
	EndTimestamp            Timestamp               `json:"endTimestamp" yaml:"endTimestamp"`
	LastUpdatedTimestamp    Timestamp               `json:"lastUpdatedTimestamp" yaml:"lastUpdatedTimestamp"`
	MetricsBuildID          MetricsBuildID          `json:"metricsBuildID" yaml:"metricsBuildID"`
	MetricsSetName          *MetricsSetName         `json:"metricsSetName" yaml:"metricsSetName"`
	MetricsStatus           MetricStatus            `json:"metricsStatus" yaml:"metricsStatus"`
	Name                    Name                    `json:"name" yaml:"name"`
	OrgID                   OrgID                   `json:"orgID" yaml:"orgID"`
	OutputLocation          string                  `json:"outputLocation" yaml:"outputLocation"`
	ProjectID               ProjectID               `json:"projectID" yaml:"projectID"`
	ReportID                ReportID                `json:"reportID" yaml:"reportID"`
	RespectRevisionBoundary RespectRevisionBoundary `json:"respectRevisionBoundary" yaml:"respectRevisionBoundary"`
	StartTimestamp          Timestamp               `json:"startTimestamp" yaml:"startTimestamp"`
	Status                  ReportStatus            `json:"status" yaml:"status"`
	StatusHistory           ReportStatusHistory     `json:"statusHistory" yaml:"statusHistory"`
	TestSuiteID             TestSuiteID             `json:"testSuiteID" yaml:"testSuiteID"`
...
type ReportInput struct {
	AssociatedAccount       *AssociatedAccount       `json:"associatedAccount,omitempty" yaml:"associatedAccount,omitempty"`
	BranchID                BranchID                 `json:"branchID" yaml:"branchID"`
	EndTimestamp            *Timestamp               `json:"endTimestamp,omitempty" yaml:"endTimestamp,omitempty"`
	MetricsBuildID          MetricsBuildID           `json:"metricsBuildID" yaml:"metricsBuildID"`
	MetricsSetName          *MetricsSetName          `json:"metricsSetName" yaml:"metricsSetName"`
	Name                    *Name                    `json:"name,omitempty" yaml:"name,omitempty"`
	PoolLabels              *PoolLabels              `json:"poolLabels,omitempty" yaml:"poolLabels,omitempty"`
	RespectRevisionBoundary *RespectRevisionBoundary `json:"respectRevisionBoundary,omitempty" yaml:"respectRevisionBoundary,omitempty"`
	StartTimestamp          Timestamp                `json:"startTimestamp" yaml:"startTimestamp"`
	TestSuiteID             TestSuiteID              `json:"testSuiteID" yaml:"testSuiteID"`
	TestSuiteRevision       *TestSuiteRevision       `json:"testSuiteRevision,omitempty" yaml:"testSuiteRevision,omitempty"`
	TriggeredVia            *TriggeredVia            `json:"triggeredVia,omitempty" yaml:"triggeredVia,omitempty"`
...
type ReportMetricsDataAndIDs struct {
	ReportMetricID    *MetricID    `json:"reportMetricID,omitempty" yaml:"reportMetricID,omitempty"`
	ReportMetricsData *MetricsData `json:"reportMetricsData,omitempty" yaml:"reportMetricsData,omitempty"`
}
...
type ReportMetricsDataToReportMetric struct {
	ReportMetricID       *MetricID        `json:"reportMetricID,omitempty" yaml:"reportMetricID,omitempty"`
	ReportMetricsDataIDs *[]MetricsDataID `json:"reportMetricsDataIDs,omitempty" yaml:"reportMetricsDataIDs,omitempty"`
}
...
type ReviseTestSuiteInput struct {
	...
	AllExperiences        *bool                   `json:"allExperiences,omitempty" yaml:"allExperiences,omitempty"`
	Description           *TestSuiteDescription   `json:"description,omitempty" yaml:"description,omitempty"`
	ExcludedExperienceIDs *[]ExcludedExperienceID `json:"excludedExperienceIDs,omitempty" yaml:"excludedExperienceIDs,omitempty"`
	Experiences           *[]ExperienceID         `json:"experiences,omitempty" yaml:"experiences,omitempty"`
	Filters               *ExperienceFilterInput  `json:"filters,omitempty" yaml:"filters,omitempty"`
	MetricsBuildID        *MetricsBuildID         `json:"metricsBuildID,omitempty" yaml:"metricsBuildID,omitempty"`
	MetricsSetName        *MetricsSetName         `json:"metricsSetName" yaml:"metricsSetName"`
	Name                  *TestSuiteName          `json:"name,omitempty" yaml:"name,omitempty"`
...
type System struct {
	...
	NumExperiences             int          `json:"numExperiences" yaml:"numExperiences"`
	NumMetricsBuilds           int          `json:"numMetricsBuilds" yaml:"numMetricsBuilds"`
	NumTestSuites              int          `json:"numTestSuites" yaml:"numTestSuites"`
	OrgID                      OrgID        `json:"orgID" yaml:"orgID"`
	ProjectID                  ProjectID    `json:"projectID" yaml:"projectID"`
	SystemID                   SystemID     `json:"systemID" yaml:"systemID"`
	UserID                     UserID       `json:"userID" yaml:"userID"`
...
type TestSuite struct {
	...
	OrgID                OrgID                `json:"orgID" yaml:"orgID"`
	ProjectID            ProjectID            `json:"projectID" yaml:"projectID"`
	ShowOnSummary        bool                 `json:"showOnSummary" yaml:"showOnSummary"`
	SummaryReferenceDate *Timestamp           `json:"summaryReferenceDate,omitempty" yaml:"summaryReferenceDate,omitempty"`
	SystemID             SystemID             `json:"systemID" yaml:"systemID"`
	TestSuiteID          TestSuiteID          `json:"testSuiteID" yaml:"testSuiteID"`
	TestSuiteRevision    TestSuiteRevision    `json:"testSuiteRevision" yaml:"testSuiteRevision"`
...
type TestSuiteBatchSummaryJobResults struct {
	BatchCreationTimestamp Timestamp      `json:"batchCreationTimestamp" yaml:"batchCreationTimestamp"`
	BatchID                BatchID        `json:"batchID" yaml:"batchID"`
	Blocker                int64          `json:"blocker" yaml:"blocker"`
	BuildCreationTimestamp Timestamp      `json:"buildCreationTimestamp" yaml:"buildCreationTimestamp"`
	BuildID                BuildID        `json:"buildID" yaml:"buildID"`
	Cancelled              int64          `json:"cancelled" yaml:"cancelled"`
	Error                  int64          `json:"error" yaml:"error"`
	Metrics                []CustomMetric `json:"metrics" yaml:"metrics"`
	Passed                 int64          `json:"passed" yaml:"passed"`
	Queued                 int64          `json:"queued" yaml:"queued"`
	Running                int64          `json:"running" yaml:"running"`
	Total                  int64          `json:"total" yaml:"total"`
	Warning                int64          `json:"warning" yaml:"warning"`
}
...
type TestSuiteSummary struct {
	Batches               []TestSuiteBatchSummaryJobResults `json:"batches" yaml:"batches"`
	BranchID              BranchID                          `json:"branchID" yaml:"branchID"`
	KeyMetric             *KeyMetric                        `json:"keyMetric" yaml:"keyMetric"`
	Name                  TestSuiteName                     `json:"name" yaml:"name"`
	ProjectID             ProjectID                         `json:"projectID" yaml:"projectID"`
	ReferenceBatch        *TestSuiteBatchSummaryJobResults  `json:"referenceBatch,omitempty" yaml:"referenceBatch,omitempty"`
	ReferenceBatchSummary *ReferenceBatchSummary            `json:"referenceBatchSummary" yaml:"referenceBatchSummary"`
	ReportID              ReportID                          `json:"reportID" yaml:"reportID"`
	Summary               struct {
		FixedTests int64 `json:"fixedTests" yaml:"fixedTests"`
		NewIssues  int64 `json:"newIssues" yaml:"newIssues"`
	...
	SystemID             SystemID             `json:"systemID" yaml:"systemID"`
	TestSuiteDescription TestSuiteDescription `json:"testSuiteDescription" yaml:"testSuiteDescription"`
	TestSuiteID          TestSuiteID          `json:"testSuiteID" yaml:"testSuiteID"`
	TestSuiteRevision    TestSuiteRevision    `json:"testSuiteRevision" yaml:"testSuiteRevision"`
}
...
type TestSuiteSummaryOutput struct {
	NextPageToken string             `json:"nextPageToken" yaml:"nextPageToken"`
	TestSuites    []TestSuiteSummary `json:"testSuites" yaml:"testSuites"`
}
...
type UpdateBuildFields struct {
	BranchID *openapi_types.UUID `json:"branchID,omitempty" yaml:"branchID,omitempty"`
...
type UpdateBuildInput struct {
	Build      *UpdateBuildFields `json:"build,omitempty" yaml:"build,omitempty"`
	UpdateMask *UpdateMask        `json:"updateMask,omitempty" yaml:"updateMask,omitempty"`
}
...
type UpdateExperienceInput struct {
	Experience *UpdateExperienceFields `json:"experience,omitempty" yaml:"experience,omitempty"`
	UpdateMask *UpdateMask             `json:"updateMask,omitempty" yaml:"updateMask,omitempty"`
}
...
type UpdateExperienceTagFields struct {
	Description *string            `json:"description,omitempty" yaml:"description,omitempty"`
	Name        *ExperienceTagName `json:"name,omitempty" yaml:"name,omitempty"`
}

// UpdateExperienceTagInput defines model for updateExperienceTagInput.
type UpdateExperienceTagInput struct {
	ExperienceTag *UpdateExperienceTagFields `json:"experienceTag,omitempty" yaml:"experienceTag,omitempty"`
	UpdateMask    *UpdateMask                `json:"updateMask,omitempty" yaml:"updateMask,omitempty"`
}
...
type UpdateProjectInput struct {
	Project    *UpdateProjectFields `json:"project,omitempty" yaml:"project,omitempty"`
	UpdateMask *UpdateMask          `json:"updateMask,omitempty" yaml:"updateMask,omitempty"`
}
...
type UpdateSystemInput struct {
	Architecture               *Architecture `json:"architecture,omitempty" yaml:"architecture,omitempty"`
	BuildGpus                  *int          `json:"build_gpus,omitempty" yaml:"build_gpus,omitempty"`
	BuildMemoryMib             *int          `json:"build_memory_mib,omitempty" yaml:"build_memory_mib,omitempty"`
...
type UpdateWorkflowInput struct {
	CiWorkflowLink *string `json:"ciWorkflowLink" yaml:"ciWorkflowLink"`
	Description    *string `json:"description,omitempty" yaml:"description,omitempty"`
	Name           *string `json:"name,omitempty" yaml:"name,omitempty"`
}

// UpdateWorkflowSuiteInput defines model for updateWorkflowSuiteInput.
type UpdateWorkflowSuiteInput struct {
	Enabled     Enabled     `json:"enabled" yaml:"enabled"`
	TestSuiteID TestSuiteID `json:"testSuiteID" yaml:"testSuiteID"`
}

// UpdateWorkflowSuiteOutput defines model for updateWorkflowSuiteOutput.
type UpdateWorkflowSuiteOutput struct {
	Enabled     Enabled     `json:"enabled" yaml:"enabled"`
	TestSuiteID TestSuiteID `json:"testSuiteID" yaml:"testSuiteID"`
	WorkflowID  WorkflowID  `json:"workflowID" yaml:"workflowID"`
}

// UpdateWorkflowSuitesInput defines model for updateWorkflowSuitesInput.
type UpdateWorkflowSuitesInput struct {
	WorkflowSuites []UpdateWorkflowSuiteInput `json:"workflowSuites" yaml:"workflowSuites"`
}

// UpdateWorkflowSuitesOutput defines model for updateWorkflowSuitesOutput.
type UpdateWorkflowSuitesOutput struct {
	WorkflowSuites []UpdateWorkflowSuiteOutput `json:"workflowSuites" yaml:"workflowSuites"`
}
...
type WorkflowRun struct {
	...
	UserID                UserID                 `json:"userID" yaml:"userID"`
	WorkflowID            WorkflowID             `json:"workflowID" yaml:"workflowID"`
	WorkflowRunID         WorkflowRunID          `json:"workflowRunID" yaml:"workflowRunID"`
	WorkflowRunTestSuites []WorkflowRunTestSuite `json:"workflowRunTestSuites" yaml:"workflowRunTestSuites"`
}
...
// WorkflowSuiteOutput defines model for workflowSuiteOutput.
type WorkflowSuiteOutput struct {
	Enabled    Enabled    `json:"enabled" yaml:"enabled"`
	TestSuite  TestSuite  `json:"testSuite" yaml:"testSuite"`
	WorkflowID WorkflowID `json:"workflowID" yaml:"workflowID"`
}
...
type CompareBatchesParams struct {
	...
	Status *CompareBatchesStatusFilter `form:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
...
type ListJobsParams struct {
	...
	Status *JobStatus `form:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`

	// ConflatedStatus Filter jobs by their conflated status
	ConflatedStatus *[]ConflatedJobStatus `form:"conflatedStatus,omitempty" json:"conflatedStatus,omitempty" yaml:"conflatedStatus,omitempty"`
...
type ListJobLogsForJobParams struct {
	Type *[]LogType `form:"type,omitempty" json:"type,omitempty" yaml:"type,omitempty"`
...
type ListExperienceTagsParams struct {
	...
	Name      *string                          `form:"name,omitempty" json:"name,omitempty" yaml:"name,omitempty"`
	OrderBy   *ListExperienceTagsParamsOrderBy `form:"orderBy,omitempty" json:"orderBy,omitempty" yaml:"orderBy,omitempty"`
	PageSize  *PageSize                        `form:"pageSize,omitempty" json:"pageSize,omitempty" yaml:"pageSize,omitempty"`
	PageToken *PageToken                       `form:"pageToken,omitempty" json:"pageToken,omitempty" yaml:"pageToken,omitempty"`
}
...
type ListMetricsBuildsParams struct {
	...
	SystemID *openapi_types.UUID `form:"systemID,omitempty" json:"systemID,omitempty" yaml:"systemID,omitempty"`
...
type ListTestSuitesParams struct {
	...
	ExperienceIDs *[]ExperienceID `form:"experienceIDs,omitempty" json:"experienceIDs,omitempty" yaml:"experienceIDs,omitempty"`
...
// DeleteWorkflowSuitesJSONRequestBody defines body for DeleteWorkflowSuites for application/json ContentType.
type DeleteWorkflowSuitesJSONRequestBody = DeleteWorkflowSuitesInput

// UpdateWorkflowSuitesJSONRequestBody defines body for UpdateWorkflowSuites for application/json ContentType.
type UpdateWorkflowSuitesJSONRequestBody = UpdateWorkflowSuitesInput

// CreateWorkflowSuitesJSONRequestBody defines body for CreateWorkflowSuites for application/json ContentType.
type CreateWorkflowSuitesJSONRequestBody = CreateWorkflowSuitesInput
...
type ClientInterface interface {
	...
	// DeleteWorkflowSuitesWithBody request with any body
	DeleteWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	DeleteWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body DeleteWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// UpdateWorkflowSuitesWithBody request with any body
	UpdateWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body UpdateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateWorkflowSuitesWithBody request with any body
	CreateWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body CreateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetWorkflowSuite request
	GetWorkflowSuite(ctx context.Context, projectID ProjectID, workflowID WorkflowID, testSuiteID TestSuiteID, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DeleteWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteWorkflowSuitesRequestWithBody(c.Server, projectID, workflowID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body DeleteWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteWorkflowSuitesRequest(c.Server, projectID, workflowID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateWorkflowSuitesRequestWithBody(c.Server, projectID, workflowID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body UpdateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateWorkflowSuitesRequest(c.Server, projectID, workflowID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateWorkflowSuitesWithBody(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateWorkflowSuitesRequestWithBody(c.Server, projectID, workflowID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateWorkflowSuites(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body CreateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateWorkflowSuitesRequest(c.Server, projectID, workflowID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetWorkflowSuite(ctx context.Context, projectID ProjectID, workflowID WorkflowID, testSuiteID TestSuiteID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetWorkflowSuiteRequest(c.Server, projectID, workflowID, testSuiteID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewDeleteWorkflowSuitesRequest calls the generic DeleteWorkflowSuites builder with application/json body
func NewDeleteWorkflowSuitesRequest(server string, projectID ProjectID, workflowID WorkflowID, body DeleteWorkflowSuitesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewDeleteWorkflowSuitesRequestWithBody(server, projectID, workflowID, "application/json", bodyReader)
}

// NewDeleteWorkflowSuitesRequestWithBody generates requests for DeleteWorkflowSuites with any type of body
func NewDeleteWorkflowSuitesRequestWithBody(server string, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/projects/%s/workflows/%s/test_suites", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewUpdateWorkflowSuitesRequest calls the generic UpdateWorkflowSuites builder with application/json body
func NewUpdateWorkflowSuitesRequest(server string, projectID ProjectID, workflowID WorkflowID, body UpdateWorkflowSuitesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateWorkflowSuitesRequestWithBody(server, projectID, workflowID, "application/json", bodyReader)
}

// NewUpdateWorkflowSuitesRequestWithBody generates requests for UpdateWorkflowSuites with any type of body
func NewUpdateWorkflowSuitesRequestWithBody(server string, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewCreateWorkflowSuitesRequest calls the generic CreateWorkflowSuites builder with application/json body
func NewCreateWorkflowSuitesRequest(server string, projectID ProjectID, workflowID WorkflowID, body CreateWorkflowSuitesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateWorkflowSuitesRequestWithBody(server, projectID, workflowID, "application/json", bodyReader)
}

// NewCreateWorkflowSuitesRequestWithBody generates requests for CreateWorkflowSuites with any type of body
func NewCreateWorkflowSuitesRequestWithBody(server string, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewGetWorkflowSuiteRequest generates requests for GetWorkflowSuite
func NewGetWorkflowSuiteRequest(server string, projectID ProjectID, workflowID WorkflowID, testSuiteID TestSuiteID) (*http.Request, error) {
	var err error
	...
	pathParam2, err = runtime.StyleParamWithLocation("simple", false, "testSuiteID", runtime.ParamLocationPath, testSuiteID)
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/projects/%s/workflows/%s/test_suites/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// DeleteWorkflowSuitesWithBodyWithResponse request with any body
	DeleteWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*DeleteWorkflowSuitesResponse, error)

	DeleteWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body DeleteWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*DeleteWorkflowSuitesResponse, error)
	...
	// UpdateWorkflowSuitesWithBodyWithResponse request with any body
	UpdateWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateWorkflowSuitesResponse, error)

	UpdateWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body UpdateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateWorkflowSuitesResponse, error)

	// CreateWorkflowSuitesWithBodyWithResponse request with any body
	CreateWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateWorkflowSuitesResponse, error)

	CreateWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body CreateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateWorkflowSuitesResponse, error)

	// GetWorkflowSuiteWithResponse request
	GetWorkflowSuiteWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, testSuiteID TestSuiteID, reqEditors ...RequestEditorFn) (*GetWorkflowSuiteResponse, error)
...
type DeleteWorkflowSuitesResponse struct {
	Body         []byte
	HTTPResponse *http.Response
}

// Status returns HTTPResponse.Status
func (r DeleteWorkflowSuitesResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteWorkflowSuitesResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type UpdateWorkflowSuitesResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *UpdateWorkflowSuitesOutput
}

// Status returns HTTPResponse.Status
func (r UpdateWorkflowSuitesResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateWorkflowSuitesResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CreateWorkflowSuitesResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *CreateWorkflowSuitesOutput
}

// Status returns HTTPResponse.Status
func (r CreateWorkflowSuitesResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateWorkflowSuitesResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetWorkflowSuiteResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *WorkflowSuiteOutput
}

// Status returns HTTPResponse.Status
func (r GetWorkflowSuiteResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetWorkflowSuiteResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// DeleteWorkflowSuitesWithBodyWithResponse request with arbitrary body returning *DeleteWorkflowSuitesResponse
func (c *ClientWithResponses) DeleteWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*DeleteWorkflowSuitesResponse, error) {
	rsp, err := c.DeleteWorkflowSuitesWithBody(ctx, projectID, workflowID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteWorkflowSuitesResponse(rsp)
}

func (c *ClientWithResponses) DeleteWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body DeleteWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*DeleteWorkflowSuitesResponse, error) {
	rsp, err := c.DeleteWorkflowSuites(ctx, projectID, workflowID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteWorkflowSuitesResponse(rsp)
...
// UpdateWorkflowSuitesWithBodyWithResponse request with arbitrary body returning *UpdateWorkflowSuitesResponse
func (c *ClientWithResponses) UpdateWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateWorkflowSuitesResponse, error) {
	rsp, err := c.UpdateWorkflowSuitesWithBody(ctx, projectID, workflowID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateWorkflowSuitesResponse(rsp)
}

func (c *ClientWithResponses) UpdateWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body UpdateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateWorkflowSuitesResponse, error) {
	rsp, err := c.UpdateWorkflowSuites(ctx, projectID, workflowID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateWorkflowSuitesResponse(rsp)
...
// CreateWorkflowSuitesWithBodyWithResponse request with arbitrary body returning *CreateWorkflowSuitesResponse
func (c *ClientWithResponses) CreateWorkflowSuitesWithBodyWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateWorkflowSuitesResponse, error) {
	rsp, err := c.CreateWorkflowSuitesWithBody(ctx, projectID, workflowID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateWorkflowSuitesResponse(rsp)
}

func (c *ClientWithResponses) CreateWorkflowSuitesWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, body CreateWorkflowSuitesJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateWorkflowSuitesResponse, error) {
	rsp, err := c.CreateWorkflowSuites(ctx, projectID, workflowID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateWorkflowSuitesResponse(rsp)
...
// GetWorkflowSuiteWithResponse request returning *GetWorkflowSuiteResponse
func (c *ClientWithResponses) GetWorkflowSuiteWithResponse(ctx context.Context, projectID ProjectID, workflowID WorkflowID, testSuiteID TestSuiteID, reqEditors ...RequestEditorFn) (*GetWorkflowSuiteResponse, error) {
	rsp, err := c.GetWorkflowSuite(ctx, projectID, workflowID, testSuiteID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetWorkflowSuiteResponse(rsp)
}
...
// ParseDeleteWorkflowSuitesResponse parses an HTTP response from a DeleteWorkflowSuitesWithResponse call
func ParseDeleteWorkflowSuitesResponse(rsp *http.Response) (*DeleteWorkflowSuitesResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &DeleteWorkflowSuitesResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUpdateWorkflowSuitesResponse parses an HTTP response from a UpdateWorkflowSuitesWithResponse call
func ParseUpdateWorkflowSuitesResponse(rsp *http.Response) (*UpdateWorkflowSuitesResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateWorkflowSuitesResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest UpdateWorkflowSuitesOutput
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseCreateWorkflowSuitesResponse parses an HTTP response from a CreateWorkflowSuitesWithResponse call
func ParseCreateWorkflowSuitesResponse(rsp *http.Response) (*CreateWorkflowSuitesResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateWorkflowSuitesResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 201:
		var dest CreateWorkflowSuitesOutput
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON201 = &dest
...
// ParseGetWorkflowSuiteResponse parses an HTTP response from a GetWorkflowSuiteWithResponse call
func ParseGetWorkflowSuiteResponse(rsp *http.Response) (*GetWorkflowSuiteResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetWorkflowSuiteResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
